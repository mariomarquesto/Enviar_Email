...
#Imagen GMAIL
imagen_gmail=Image.open("C:/Users/mario/Desktop/ENVIAR_EMAIL/logo_gmail.png")
...
Label(ventana, text="Mi correo: mariomarquesto@gmail.com",fg="white",bg="blue",font=("Arial", 10,"bold"),padx=5,pady=5).grid(row=2,column=0,columnspan=2,pady=5)
...
"------------ENVIO DE CORREO------------"
def enviar_email():
    remitente = "mariomarquesto@gmail.com"
    #Estrutura de email
    email = EmailMessage()
